...
bot_token = '7335032114:AAHYvubBycrdfUA1IfnhlTtPg2eeQ6wQnRE'  # Replace with your bot token
...
ADMIN_ID = 1661744209  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @VIPKAMISAMA: {ADMIN_ID}")
